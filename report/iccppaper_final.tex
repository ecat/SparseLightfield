...
\end{center}
   \caption{Pictoral diagram of a lightfield as seen through a microlens array. Each microlens allows different pixels to see the scene from a different angular perspective.}
\end{figure}
